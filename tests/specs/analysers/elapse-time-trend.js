describe('Elapse time trend analyser builds a result that', function () {
    ...
    resultAsc = analyser.getResult(numbers, draws, 16, sorterAsc, sorterAsc);
    resultDesc = analyser.getResult(numbers, draws, 16, sorterDesc, sorterDesc);
